...
const Settings = {
  ...
  //THIS IS IMPORTANT\\
  GUILD_ID: "884614462529765426", // THIS IS VERY IMPORTANT, THIS IS THE ID OF YOUR SERVER, SEARCH ON YOUTUBE HOW TO GET IT IF YOU DONT KNOW HOW
  OWNER_ID: "786836423176224768", // THIS IS VERY IMPORTANT, THIS IS THE ID OF YOUR PROFILE, SEARCH ON YOUTUBE HOW TO GET IT IF YOU DONT KNOW HOW
  Shoppy_API_KEY: "8OnGbZdNVPTxGkF7UqAzSAQIkp0TLEnYEZSu7fcpRHiQXbsWnv", // Create a Shoppy account If you haven't, then go to https://shoppy.gg/user/settings and look for your "API-KEY".
  Whitelisted_Role_ID: "885395385714114610", // When users use the !whitelist or !rewhitelist command, they get this role.
  Blacklisted_Role_ID: "885395397210677268", // When users who are not whitelist use the !rewhitelist command with a buyers Shoppy Order ID, they get this role.
  LogsChannel_Channel_ID: "884624216907980862", // Create a channel for logs when a user is whtelisted or uses a command!
  //----------------\\
   ...
   .then(function (res) { 
     ...
     else
     {
       if (res.data["confirmations"] === 1 && res.data["product"]["confirmations"]) {
         ...
         message.reply("_G.Key = '"+key+"'\nloadstring(game:HttpGet('https://uuyghdrgherxyhru.000webhostapp.com/pumpkin.lua'))()") // Change PROJECTNAME to the project u made on heroku!!!
